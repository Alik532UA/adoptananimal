...
Це вигідна позиція, і її варто зберегти: у сусідніх проєктах база вписана константою, і саме через це `as5.odesa.ua` після купівлі домену місяцями показувався системними шрифтами. Перш ніж вибирати адресу — [CUSTOM-DOMAIN-v8.md](../sveltekit-canon/selection_criteria/v8/ops/CUSTOM-DOMAIN-v8.md).
